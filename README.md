...
The "because" text is generated by the application from the tool name and arguments. It is meant to explain the agent workflow, not reveal hidden model reasoning.
